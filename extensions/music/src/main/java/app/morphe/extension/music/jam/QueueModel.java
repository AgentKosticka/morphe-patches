...
public final class QueueModel {
    ...
    private static final int MUSIC_RESPONSIVE_LIST_ITEM_RENDERER_FIELD = 51_779_701;
    ...
    private static byte[] label(String value){return text(LABEL_TEXT_FIELD,value);}
    ...
    public static byte[] encode(String video,String title,String artist,String picture){
         ...
         */
        byte[] watch=field(WATCH_ENDPOINT_FIELD,text(WATCH_VIDEO_ID_FIELD,video));
        byte[] thumbnail=field(THUMBNAIL_LIST_FIELD,text(THUMBNAIL_URL_FIELD,thumbnail(picture,video)));
        ...
        return field(WRAPPER_RENDERER_FIELD,field(MUSIC_RESPONSIVE_LIST_ITEM_RENDERER_FIELD,renderer));
    }
}
