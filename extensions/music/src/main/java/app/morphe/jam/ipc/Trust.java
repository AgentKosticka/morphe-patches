...
public final class Trust {
  ...
  public static final String COMPANION_CERT =
    "46f5e42763b17777fb527b1477ae88b3649ec6c14674d232477e70d6e7e91940";
  ...
  public static String certificate(Context context, String pkg) {
    try {
      Signature[] signatures = context
        ...
        .signatures;
      if (
        signatures == null || signatures.length != 1
      ) throw new SecurityException("Signer count");
      ...
      throw new SecurityException("Package signature unavailable", error);
    }
  }
  ...
  public static void caller(Context context, String pkg, String cert) {
    ...
    if (
      packages == null ||
      packages.length != 1 ||
      !pkg.equals(packages[0]) ||
      !equal(cert, certificate(context, pkg))
